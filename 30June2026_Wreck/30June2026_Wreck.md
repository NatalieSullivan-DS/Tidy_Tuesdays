...
I asked Gemini to help walk me through how to conduct a more advanced
data analysis. First, we are going to see how the cause of wrecks
changed over time. Then, we are going to try to map the data using the
latitude and longitude data, but first I want to find out if this is
viable. How many missing latitude values are there?
...
There are 168 out of 648 total missing latitude values, which is viable.
Let’s focus on the cause of wrecks over time first.
...
```
    ...
    ## ℹ Summaries were computed grouped by year and word.
    ## ℹ Output is grouped by year.
    ## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
    ## ℹ Use `summarise(.by = c(year, word))` for per-operation grouping
...
![](30June2026_Wreck_files/figure-gfm/wrecksCause-1.png)<!-- -->

In 1940, torpedoes and being sunk were among the highest cause of
wrecks, but these causes decrease over time until the last tow years of
the war when torpedoes and being sunk increase again.
...
![](30June2026_Wreck_files/figure-gfm/mapWrecks-1.png)<!-- -->
